...
ROOT_PATH = 'root/'
ACCES_USERS = os.environ.get('YosmelGarcia','LevAndrade93').split(';')
PROXY = ProxyCloud.parse(os.environ.get('proxy_enc','socks5h://KGGJJJYIJFLIFEYDJFLEKHYGCHDHRHHKCHHGCE'))
